...
sealed class NotesListResult {
    data class SuccessfullyLoaded(val noteList: List<NoteEntity>) : NotesListResult() // loaded successfully
    data class LoadedWithException(val message: String) : NotesListResult() // loaded with exception
